...
// SystemConfigFeeScalars is an auto generated low-level Go binding around an user-defined struct.
type SystemConfigFeeScalars struct {
...
// Initialize is a paid mutator transaction binding the contract method 0x120d3f1f.
//
// Solidity: function initialize(address _owner, (uint32,uint32,uint32,uint64) _feeScalars, bytes32 _batcherHash, uint64 _gasLimit, address _unsafeBlockSigner, (uint32,uint8,uint8,uint32,uint32,uint128) _config, address _batchInbox, (address,address,address,address,address,address,address) _addresses) returns()
func (_SystemConfig *SystemConfigTransactor) Initialize(opts *bind.TransactOpts, _owner common.Address, _feeScalars SystemConfigFeeScalars, _batcherHash [32]byte, _gasLimit uint64, _unsafeBlockSigner common.Address, _config IResourceMeteringResourceConfig, _batchInbox common.Address, _addresses SystemConfigAddresses) (*types.Transaction, error) {
	return _SystemConfig.contract.Transact(opts, "initialize", _owner, _feeScalars, _batcherHash, _gasLimit, _unsafeBlockSigner, _config, _batchInbox, _addresses)
}
...
func (_SystemConfig *SystemConfigSession) Initialize(_owner common.Address, _feeScalars SystemConfigFeeScalars, _batcherHash [32]byte, _gasLimit uint64, _unsafeBlockSigner common.Address, _config IResourceMeteringResourceConfig, _batchInbox common.Address, _addresses SystemConfigAddresses) (*types.Transaction, error) {
	return _SystemConfig.Contract.Initialize(&_SystemConfig.TransactOpts, _owner, _feeScalars, _batcherHash, _gasLimit, _unsafeBlockSigner, _config, _batchInbox, _addresses)
}
